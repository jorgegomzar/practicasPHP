...
<html lang="es" dir="ltr">
  ...
  <body>
    <header class="jumbotron text-center">
      <h1 class="display-3">Asteriscos</h1>
    </header>
    <main class="container">
      <div class="row justify-content-center">
        <div class="col-6 col-xs-12">
          <form class="form" method="get" action="./ejercicio01.php">
          ...
          <?php
          $err = "<p class=\"text-danger\">Error, el número no puede dejarse en blanco, ni ser negativo ni cero.</p>";
          if (!empty($_GET)) {
            $num =  $_GET['num'];
            if ($num > 0) {
